...
num_views=7  # to execute this code select line number 62 to 67 and click on run
if(num_views>20)
{
...
# else-if
marks=95 # Try 90,80,75,60,55,40,35,20
if(marks>80){
  print("Excellent")
...
var1 = as.integer(readline(prompt = "Enter any number : "));
var2 = as.integer(50);
var3 = as.integer(22);
var4 = as.integer(47);
